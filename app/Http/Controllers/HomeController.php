...
//                        if(null !== $tgUs && $tgUs->tg_user_id == "344878981") {
                            ...
                            $text = "Добрый день, " . ($priemRequest->tguser->fio ?? 'абитуриент') . "! Предыдущее сообщение мы отправили по ошибке, ведь мы хотели узнать твое мнение про уже прошедшее мероприятие! \n\n";
